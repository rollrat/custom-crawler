...
namespace MasterDevs.ChromeDevTools.Protocol.Chrome.Runtime
{
	...
	/// Gets or sets Identifier of the object to return properties for.
		...
		/// <summary>
	/// Gets or sets If true, returns properties belonging only to the element itself, not to its prototype
	/// chain.
		/// </summary>
		[JsonProperty(NullValueHandling = NullValueHandling.Ignore)]
		public bool? OwnProperties { get; set; }
		/// <summary>
	/// Gets or sets If true, returns accessor properties (with getter/setter) only; internal properties are not
	/// returned either.
		/// </summary>
		[JsonProperty(NullValueHandling = NullValueHandling.Ignore)]
