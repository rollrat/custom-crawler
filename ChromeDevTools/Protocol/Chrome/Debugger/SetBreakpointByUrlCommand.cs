...
namespace MasterDevs.ChromeDevTools.Protocol.Chrome.Debugger
{
	...
	/// Gets or sets URL of the resources to set breakpoint on.
		...
		/// <summary>
	/// Gets or sets Regex pattern for the URLs of the resources to set breakpoints on. Either `url` or
	...
	/// Gets or sets Offset in the line to set breakpoint at.
		...
		/// <summary>
	/// Gets or sets Expression to use as a breakpoint condition. When specified, debugger will only stop on the
