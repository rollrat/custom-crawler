...
namespace MasterDevs.ChromeDevTools.Protocol.Chrome.CSS
{
	...
	{
		/// <summary>
	/// Gets or sets The range of background colors behind this element, if it contains any visible text. If no
	...
	/// Gets or sets The computed font size for this node, as a CSS computed value string (e.g. '12px').
		...
		/// <summary>
	/// Gets or sets The computed font weight for this node, as a CSS computed value string (e.g. 'normal' or
	/// '100').
		/// </summary>
		[JsonProperty(NullValueHandling = NullValueHandling.Ignore)]
